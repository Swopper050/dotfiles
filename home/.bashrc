...
alias ui='cd ~/acs/climatics/climate/python/ui'
alias tasks='cd ~/acs/climatics/climate/python/tasks'
alias zeus='cd ~/acs/climatics/climate/python/zeus'
alias gaia='cd ~/acs/climatics/climate/python/gaia'
